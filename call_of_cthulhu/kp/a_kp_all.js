...
// @timestamp    1779120768
// 2025-05-11 16:49:17
// @license      Apache-2
// @homepageURL  https://github.com/errrr-er/alll/tree/main
// @updateUrl    https://hk.gh-proxy.org/https://raw.githubusercontent.com/errrr-er/alll/refs/heads/main/call_of_cthulhu/kp/a_kp_all.js
...
async function getGitHubVersion() {
    try {
		// 镜像
        const rawUrl = 'https://hk.gh-proxy.org/https://raw.githubusercontent.com/errrr-er/alll/refs/heads/main/call_of_cthulhu/kp/a_kp_all.js';
...
const groupMap = {
	...
	"多灾多难梵达林": { groupNumber: "570879430", aliases: ["矿坑","冰塔峰","风暴君王","风骸岛"] },
	"恶辣": { groupNumber: "620832218" },
	"二重身的证迹": { groupNumber: "285230351" },
	"翻译": { groupNumber: "1073856681\n1053204546\n972416799\n377896614\n1040799893\npd59993369\n1033917987\n1043393781\n872345826\n1061035045\n220150371*韩模\nny40y57197" },
	...
	"歌味觉死": { groupNumber: "616756545", aliases: ["路易斯安那系列","畅梦人","淤泥之花与空心石"] },
	...
	"将潮水遗忘之物也一并收下吧": { groupNumber: "904394289*下载" },
	"将钟表拨回茶杯摔破之前": { groupNumber: "651922911*下载" },
	...
	"龙后的宝山": { groupNumber: "343516463", aliases: ["提亚马特的崛起"] },
	...
	"请生下他吧": { groupNumber: "705913038" },
	"秋鬼": { groupNumber: "1095696359*下载" },
	"秋永录": { groupNumber: "922420972\n712714985", aliases: ["qyl"] },
	...
	"性福安心委員会": { groupNumber: "https://koufukuanshiniinkai.wixsite.com/trpg", aliases: ["性福安心委员会"] },
	...
	"寻仙I神仙索": { groupNumber: "746673328*下载", aliases: ["寻仙II观音土"] },
	"鸦阁领域": { groupNumber: "836306797" },
	"哑蝉的剖白": { groupNumber: "613231813" },
	...
	"艺术是死": { groupNumber: "902444229", aliases: ["1444","ysss"] },
	...
	"永虹灰归的Polis": { groupNumber: "696523899" },
	"永夜后日谈": { groupNumber: "710242752" },
	"幽世常世的满天下": { groupNumber: "749173986" },
	"幽诱,于指尖燃起": { groupNumber: "978331360" },
	...
	"语音": { groupNumber: "893711161*主dnd但不限" },
	...
	"长天摘星": { groupNumber: "552342168*无剧透\n595926395*KP" },
	...
	"最后的祝福": { groupNumber: "1005831724*下载" },
	"左川之国失落谭": { groupNumber: "770779991" },
	...
	"R∈D - Re:Dawn -": { groupNumber: "859997225", aliases: ["R∈D","Re:Dawn"] },
